        ...
        <section id="about" class="about">
            ...
            <div class="executives">
                ...
                <ul>
                    ...
                    <li>Denilson Conceição de Oliveira: <span>Diretor de Marketing. Responsável por todas as atividades de marketing dentro da empresa, incluindo estratégias de publicidade, pesquisa de mercado, desenvolvimento de produtos e comunicação com o cliente.</span></li>
                    <li>Leonardo Zanata de Jesus: <span>Diretor de Operações. Responsável pelas operações diárias da empresa, incluindo a produção, logística, recursos humanos, e outros aspectos operacionais. Atua para garantir que as operações da empresa sejam eficientes e eficazes.</span></li>
                </ul>
            </div>
        </section>
