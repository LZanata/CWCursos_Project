<?php
session_start();
include '../../../funcoes/conexao.php'; // ajuste conforme necessário

$busca = $_GET['busca'] ?? '';
$type = $_GET['type'] ?? 'aluno'; // pode ser aluno, professor ou administrador
...
<head>
    <meta charset="UTF-8">
    <title><?= ucfirst($type) ?>s Cadastrados</title>
