                            ...
                            <div class='customer-wrapper'>
                                <div class='customer-menu-box'>
                                    ...
                                    <ul class='customer-actions'>
                                        ...
                                        <li><a target="_blank" href="suporte.html">Suporte</a></li>
                ...
                <div class='mainnav mainnav-pt-BR' id='mainnav' role='navigation'>
                    <ul>
                        <li class='mainnav-item nav-li nav-li-js' id='mainnav-panel'>
                            <a class="mainnav-item-link" href="forum.html">Fórum de Dúvidas</a>
                        </li>
                        <li class='mainnav-item nav-li nav-li-js' id='mainnav-my-courses'>
                            <a class="mainnav-item-link" href="/customer/brand/courses">Meus cursos</a>
                            <div class='nav-arrow nav-arrow-js'></div>
                            <div class='subnav nav-sub nav-sub-js'>
                                <ul class='subCMSListMenuUL' id='CMSListMenu3'>
                                    <li class='subCMSListMenuLI'><a class="subCMSListMenuLink" href="/customer/brand/courses">Todos os cursos</a></li>
                                    <li class='subCMSListMenuLI'><a class="subCMSListMenuLink linkSecondColor" href="provas.html">Provas</a></li>
                                    ...
                                    <li class='subCMSListMenuLI'>
                                        <a class="subCMSListMenuLink linkSecondColor" id="create-a-new-course" data-remote="true" href="/courses/new">
