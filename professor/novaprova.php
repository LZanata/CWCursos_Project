                ...
                <div class='col-md-12'>
                    <div class='row'>
                        <div class='col-md-12 text-center'>
                            <p class='lead'>
                                Editando prova
                                <span class='quiz-page-title'>
                                </span>
                            </p>
                        </div>
                    </div>
                    <div class='form-edit-quiz_container'>
                        <form id="edit-quiz-form" class="simple_form edit_exam" action="/customer/brand/exams/767" accept-charset="UTF-8" method="post">
                            <input name="utf8" type="hidden" value="&#x2713;" />
                            <input type="hidden" name="_method" value="patch" />
                            <input type="hidden" name="authenticity_token" value="P3tK0qrD8JCVBIrfAK6rAu/H9Q/T9Ms4K6w4o5qA9d2eS7cXt1cHAxJl/lfuVIWnQ6N2a5gbGBkBK4I/a6WQOQ==" />
                            <div class='row'>
                                <div class='col-md-8'>
                                    <p class='form-edit-quiz_container__title'>Nome da prova:</p>
                                    <div class="input string required exam_name">
                                        <input class="string required form-control" placeholder="Digite o nome da prova" required="required" aria-required="true" type="text" value="dgdg" name="exam[name]" id="exam_name" />
                                    </div>
                                </div>
                                <div class='col-md-4'>
                                    <p class='form-edit-quiz_container__title'>Porcentagem para aprovação</p>
                                    <div class="input integer optional exam_passing_percentage">
                                        <input class="numeric integer optional form-control" min="1" max="100" type="number" step="1" value="50" name="exam[passing_percentage]" id="exam_passing_percentage" />
                                    </div>
                                </div>
                            </div>
                            <div class='form-edit-quiz_footer'>
                                <label class="checkbox primary" for="check-box-767">
                                    <input name="exam[is_active]" type="hidden" value="0" />
                                    <input id="check-box-767" class="custom-checkbox" data-toggle="checkbox" type="checkbox" value="1" checked="checked" name="exam[is_active]" />Publicado

                                </label>
                                <input type="submit" name="commit" value="Salvar alterações" class="btn btn-primary green" />
                            </div>
                        </form>
                    </div>
                    <div class='form-edit-quiz__title_container'>
                        <h2>Perguntas e respostas da prova:</h2>
                        <a class="btn btn-primary green" href="/customer/brand/exams/767/questions/new">Cadastrar nova pergunta
                        </a>
                    </div>
                    <div class='list-edit-quiz__container'>
